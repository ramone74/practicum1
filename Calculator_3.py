...
def calc(exp=list(str(input('Вводите: ')).split(' '))):
    ...
    f2_1 = 0 #флаг дробной части, 1 - тыс, 2 - сот, 3 - дес
    a = 0 #первое число. Цикл ниже его считает
    ...
    f2 = 0
    f2_1 = 0
    b = 0 #второе число, считаем в цикле ниже
    ...
    if f1 == 1:
        ...
        res = a ** b
    res_int = int(res) #целая часть числа
    res_frac = round(res - res_int, 3) #дробная часть числа
    if (res_frac * 1000) % 100 == 0:
        ...
        f2_1 = 1
    #ниже обработка правильного вывода для всех чисел
